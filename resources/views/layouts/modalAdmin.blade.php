...
<form action="" method="post">
  @csrf
  <div class="modal fade" id="exampleModal{{ $user->dni }}" tabindex="-1" aria-labelledby="exampleModalLabel{{ $user->dni }}" aria-hidden="true">
    <div class="modal-dialog">
      <div class="card text-center">
        <div class="card__img mx-auto"><svg xmlns="http://www.w3.org/2000/svg" width="100%">
        ...
        <div class="card__subtitle">{{ $user->dni }}</div>
