...
<div class="row status-danger">
    <div class="mx-3 success">
        ...
        <div class="success__title">{{ session('status') }}</div>
        <div class="success__close" onclick="document.querySelector('.status-danger').style.display = 'none';"><svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 20 20" height="20">
