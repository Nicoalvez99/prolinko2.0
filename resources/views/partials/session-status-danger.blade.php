...
<div class="row status-danger">
    <div class="mx-3 error">
        ...
        <div class="error__title">{{ session('status') }}</div>
        <div id="close" class="error__close" onclick="document.querySelector('.status-danger').style.display = 'none';"><svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 20 20" height="20">
