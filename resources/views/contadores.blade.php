...
<head>
    ...
    <title>Prolinko | Contadores</title>
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="#">
                                <img class="header-logo-image" src="{{ asset('images/Logo.PNG') }}" width="50" alt="Logo">
                            </a>
                        </h1>
                    </div>
                </div>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title mt-0">Prolinko</h1>
                            <p class="hero-paragraph">Conectando Clientes y Contadores para Simplificar la Gestión Financiera: Tu Solución Integral en Contabilidad y Finanzas Empresariales.</p>
                            <div class="hero-cta">
                                @if (Route::has('login'))
                                @auth
                                <a class="button button-primary" href="{{ url('/contador') }}">Contador</a>
                                @else
            ...
            <div class="container">
                <div class="site-footer-inner">
                    <div class="brand footer-brand">
                        <a href="#">
                            <img class="header-logo-image" src="{{ asset('images/Logo.PNG') }}" width="40" alt="Logo">
                        </a>
                    </div>
